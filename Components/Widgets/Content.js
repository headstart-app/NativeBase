...
export default class Content extends NativeBaseComponent {
  ...
  render() {
    ...
    return(
      <KeyboardAwareScrollView ref={c => this._scrollview = c} resetScrollToCoords={{x:0,y:0}} {...this.prepareRootProps()} contentContainerStyle={contentContainerStyle} contentInset={{bottom:0}}>{this.props.children}</KeyboardAwareScrollView>
    );
  }
}
